...
public class CreateFileServlet extends HttpServlet {
    ...
    private static final Logger log = Logger.getLogger(CreateFileServlet.class.getName());
    /**
...
//[START doGet]
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        int fileSize = Integer.parseInt(req.getParameter("size"));
...
//[END doGet]
    ...
    private GcsFilename getFileName(HttpServletRequest req) {
        ...
        if (!splits[0].equals("") || !splits[1].equals("createfile")) {
            throw new IllegalArgumentException("The URL is not formed as expected. " +
                    "Expecting /createfile/<bucket>/<object>");
        }
